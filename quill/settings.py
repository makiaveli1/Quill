"""
Django settings for quill project.
...
# Check if the app is running on Heroku with AWS S3
if 'USE_AWS' in os.environ:
    ...
    # Tell Django to use S3 for static and media files
    STATICFILES_STORAGE = 'storages.backends.s3boto3.S3Boto3Storage'
    DEFAULT_FILE_STORAGE = 'storages.backends.s3boto3.S3Boto3Storage'

    # Tell Django where static and media files are in S3
...
# stripe
STRIPE_CURRENCY = 'usd'
STRIPE_PUBLIC_KEY = os.getenv('STRIPE_PUBLIC_KEY', 'pk_test_51N09VeLjvedDFbO8idQXGR1C2wWZrleEyxhodHaQChr2fRNmak0BVCDLHunCaVwpXOPE9MLqC13z0iH8gYWCq6GB00MYhzMEym')
